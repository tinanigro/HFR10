namespace Hfr.Utilities
{
    public static class HFRUrl
    {
        ...
        public static readonly string WikiSmileySearch = "wikismilies.php?config=hfr.inc&threecol=0" + "&findkeyword=";
        public static readonly string RehostUpload = "http://reho.st/upload";
